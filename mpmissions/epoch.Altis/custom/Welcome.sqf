...
_sizeTitle             = 0.9; // Font Size of the Title Messages
_sizeSubText         = 0.75;  // Font Size of the SubTitle Messages
...
_posDefault         = [0.1,0.55,0.5]; // Defualt Positions of all Credits




_title             = "Welcome Survivor";
_shorttext         = "Arma 3 Epoch By 99 บาท";
_posText        = [0.7,0.5,0.4];


_title2         = "Website";
_shorttext2     = "www.99b.com";
_posText2        = [0.7,0.5,0.25];


_title3            = "Teamspeak 3";
_shorttext3     = "ts.99b.com";
_posText3        = [0.7,0.5,0.25];


_title4         = "Donate";
_shorttext4     = "Support the server and Help it stay up";
_posText4        = [0.7,0.5,0.28];


_title5         = "Custom Scripts";
_shorttext5     = "Welcome Messages <br />AI Missions<br />Custom Traders<br /> ";
_posText5        = [0.7,0.5,0.335];


_title6         = "Play Fair And Enjoy";
_shorttext6     = "Admins are Always Active";
_posText6        = [0.7,0.5,0.4];
