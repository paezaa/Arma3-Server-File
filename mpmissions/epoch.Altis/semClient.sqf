...
[] spawn {	waitUntil{player == player && !isNil "SEM_version"}; sleep 50;
	...
	titleText [format["\nWelcome to ABC %1 survivor %2.", _worldName, name player], "PLAIN DOWN", 2];
	sleep 15;
	titleText [format["This server is running %1 v%2", str "Epoch Missions NeverDie", SEM_version], "PLAIN DOWN", 2];
