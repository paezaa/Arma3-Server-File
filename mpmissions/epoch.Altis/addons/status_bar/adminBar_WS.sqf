...
disableSerialization;
	...
	while {true} do 
	{
		...
		((uiNamespace getVariable "osefStatusBarAdminWS")displayCtrl 55554)ctrlSetStructuredText parseText 
			...
			<t shadow='1' shadowColor='#000000' color='%18'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\toxicity.paa' color='%18'/>%19</t> 
			...
			<t shadow='1' shadowColor='#000000' color='%10' size='0.9'>POS: %16</t>
			<t shadow='1' shadowColor='#000000' color='%10' size='0.9' >DIR: %17</t>",
					"%", 
					count playableUnits,
					_damage,
					_wallet, 
