...
disableSerialization;
	...
	while {true} do 
	{
		...
		((uiNamespace getVariable "osefStatusBar")displayCtrl 55555)ctrlSetStructuredText parseText 
			format["
			<t shadow='1' shadowColor='#000000' color='%10'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\players.paa' color='%10'/>%2</t>
			<t shadow='1' shadowColor='#000000' color='%11'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\damage.paa' color='%11'/>%3%1</t> 
			<t shadow='1' shadowColor='#000000' color='%10'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\krypto.paa' color='%10'/>%4</t> 
			<t shadow='1' shadowColor='#000000' color='%12'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\hunger.paa' color='%12'/>%5%1</t> 
			<t shadow='1' shadowColor='#000000' color='%13'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\thirst.paa' color='%13'/>%6%1</t> 
			<t shadow='1' shadowColor='#000000' color='%15'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\stamina.paa' color='%15'/>%9</t>
			<t shadow='1' shadowColor='#000000' color='%19'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\toxicity.paa' color='%19'/>%20</t>
			<t shadow='1' shadowColor='#000000' color='%14'><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\energy.paa' color='%14'/>%8%1</t> 
			<t shadow='1' shadowColor='#000000' color='%10' size='0.9'>FPS: %7</t>
			<t shadow='1' shadowColor='#000000' color='%10' size='0.9'>GRIDREF: %16</t>
			<t shadow='1' shadowColor='#000000' color='%10' ><img size='0.9'  shadowColor='#000000' image='addons\status_bar\images\restart.paa' color='%10'/>%17:%18</t>",
					"%", 
					count playableUnits,
					_damage,
					_wallet, 
